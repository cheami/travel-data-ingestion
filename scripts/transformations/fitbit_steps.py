...
def process_fitbit_steps(datasets_config, engine, hook, load_id=None):
    ...
    try:
        ...
        for load_id in load_ids:
            trans_id = log_transformation_start(hook, load_id, 'fitbit_steps', 'hourly_step_count')
            try:
                ...
                if not df_steps.empty:
                    ...
                    log_transformation_end(hook, trans_id, 'SUCCESS', len(df_final))
                else:
