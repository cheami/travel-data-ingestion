    ...
    try:
        ...
        for load_id in load_ids:
            ...
            try:
                ...
                # Identify timestamp and value columns dynamically or use defaults
                ...
                df_hr['date'] = df_hr['log_timestamp'].dt.date
                df_hr['hour'] = df_hr['log_timestamp'].dt.hour
