...
def process_fitbit_heart_rate(datasets_config, engine, hook, load_id=None):
    ...
    try:
        ...
        for load_id in load_ids:
            trans_id = log_transformation_start(hook, load_id, 'fitbit_heart_rate', 'heart_rate_minute_log, heart_rate_hourly_summary')
            try:
                ...
                if not df_hr.empty:
                    ...
                    log_transformation_end(hook, trans_id, 'SUCCESS', len(df_hr))
                else:
